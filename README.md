...
<div align="center" style="background-color:#0D1117; padding:20px 20px 30px; border-radius:0 0 20px 20px;">
  ...
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=20&duration=3000&pause=1000&color=A855F7&center=true&vCenter=true&width=750&lines=IT+Engineering+Student+%7C+6th+Term;Software+Engineer+Intern+%40+Redcon+Automation;Backend+%26+Infrastructure+Enthusiast;Operating+daily+on+bare-metal+Linux;Building+my+own+homelab" alt="Typing SVG" />
  </a>
  ...
  <p style="margin:10px 0;">
    <img src="https://img.shields.io/badge/Software%20Engineer%20Intern-Redcon%20Automation-A855F7?style=for-the-badge" alt="Role">
    <img src="https://img.shields.io/badge/IT%20Engineering%20Student-6th%20Term-A855F7?style=for-the-badge" alt="Student">
  </p>
  ...
  <div style="max-width:600px; margin:25px auto 0; padding:18px 24px; background-color:#161B22; border:1px solid #30363D; border-radius:12px;">
    <p style="color:#E0E0F0; font-size:14px; line-height:1.6; margin:0;">
      I'm a <strong style="color:#B388FF;">Software Engineer Intern at Redcon Automation</strong>, building solid foundations in <strong style="color:#B388FF;">backend, automation, and containers</strong> through personal labs and continuous learning — I use Linux daily to understand how software works under the hood, not just the theory.
    </p>
  </div>
</div>
...
<h2 align="center" style="color:#B388FF;">Tech Stack</h2>

<h3 align="center" style="color:#B388FF;">Languages and Databases</h3>
<div align="center">
...
<h3 align="center" style="color:#B388FF;">Backend &amp; APIs</h3>
<div align="center">
...
<h3 align="center" style="color:#B388FF;">Frontend &amp; Client-Side</h3>
<div align="center">
...
<h3 align="center" style="color:#B388FF;">Infrastructure &amp; DevOps</h3>
<div align="center">
...
<h3 align="center" style="color:#B388FF;">Tools &amp; Terminal</h3>
<div align="center">
...
<div align="center" style="background-color:#0D1117; border:1px solid #2E2440; border-radius:14px; padding:25px 20px; margin:0 10px;">
  <h3 style="color:#B388FF; font-weight:500; letter-spacing:1.8px; margin:0 0 20px; font-size:15px;">▸ CURRENTLY AT REDCON AUTOMATION</h3>

  <div align="left" style="display:inline-block; text-align:left; color:#C9D1D9; font-size:14px; line-height:1.7; max-width:650px;">
    <p style="margin:0 0 14px;">🔹 <b>End-to-end project ownership:</b> Architecting full-stack web solutions from database to client, refactoring legacy systems under real-world best practices to ensure high availability.</p>
    <p style="margin:0 0 14px;">🔹 <b>Technical modernization &amp; infrastructure:</b> Driving the migration of production workloads to modern core stacks while managing cloud environments and internal IT operations.</p>
    <p style="margin:0;">🔹 <b>Engineering standards enforcement:</b> Embedding automated deployment workflows, continuous integration, and clean code standards into every project lifecycle.</p>
  </div>
</div>
...
<div align="center" style="background-color:#0D1117; border:1px solid #2E2440; border-radius:14px; padding:25px 20px; margin:0 10px;">
  ...
  <div style="background-color:#1A1E2B; border:1px solid #30363D; border-left:3px solid #B388FF; border-radius:10px; padding:16px 18px 16px 16px; margin:0 0 20px; text-align:left;">
  ...
  <div style="background-color:#1A1E2B; border:1px solid #30363D; border-left:3px solid #B388FF; border-radius:10px; padding:16px 18px 16px 16px; margin:0; text-align:left;">
    <p style="margin:0 0 6px;">
    ...
    <details>
      <summary style="color:#B388FF; cursor:pointer; font-weight:600;">Show details</summary>
      <ul style="color:#C9D1D9; font-size:13px; padding-left:20px; margin:8px 0 0;">
...
<div align="center" style="background-color:#0D1117; border:1px solid #2E2440; border-radius:14px; padding:25px 20px; margin:0 10px;">
  ...
  <details>
    ...
    <br>
    <ul align="left" style="color:#C9D1D9; display:inline-block; text-align:left; font-size:13px;">
